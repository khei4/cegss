...
if(ALIVE2_SOURCE_DIR)
  ...
  message(SEND_ERROR "Alive2 source directory is not set. Use -DALIVE2_SOURCE_DIR to set the directory.")
endif()

if(ALIVE2_BUILD_DIR)
  find_library(ALIVE2_IR_LIBS ir PATHS "${ALIVE2_BUILD_DIR}" NO_DEFAULT_PATH)

  # find_library(ALIVE2_LLVM_UTIL llvm_util PATHS "${ALIVE2_BUILD_DIR}" NO_DEFAULT_PATH)
  ...
  # set(ALIVE_LIBS ${ALIVE2_IR_LIBS} ${ALIVE2_LLVM_UTIL} ${ALIVE2_SMT_LIBS} ${ALIVE2_TOOLS_LIBS} ${ALIVE2_UTIL_LIBS})
  ...
  message(SEND_ERROR "Alive2 build directory is not set. Use -DALIVE2_BUILD_DIR to set the directory.")
endif()
