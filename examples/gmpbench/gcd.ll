...
if.end:                                           ; preds = %entry
  ...
  %arraydecay10 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %x, i64 0, i64 0
  %arraydecay11 = getelementptr inbounds [1 x %struct.__gmp_randstate_struct], ptr %rs, i64 0, i64 0
  %9 = load i64, ptr %m, align 8
  call void @__gmpz_urandomb(ptr noundef %arraydecay10, ptr noundef %arraydecay11, i64 noundef %9)
  %arraydecay12 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %y, i64 0, i64 0
  %arraydecay13 = getelementptr inbounds [1 x %struct.__gmp_randstate_struct], ptr %rs, i64 0, i64 0
  %10 = load i64, ptr %n, align 8
  call void @__gmpz_urandomb(ptr noundef %arraydecay12, ptr noundef %arraydecay13, i64 noundef %10)
...
do.body:                                          ; preds = %if.end
  ...
  %arraydecay16 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %z, i64 0, i64 0
  %arraydecay17 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %x, i64 0, i64 0
  %arraydecay18 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %y, i64 0, i64 0
  call void @__gmpz_gcd(ptr noundef %arraydecay16, ptr noundef %arraydecay17, ptr noundef %arraydecay18)
  br label %do.body19

do.body19:                                        ; preds = %do.cond, %do.body
  %12 = load i64, ptr %__times, align 8
  %shl = shl i64 %12, 1
  store i64 %shl, ptr %__times, align 8
  %call20 = call i32 @cputime()
  %conv21 = sext i32 %call20 to i64
  store i64 %conv21, ptr %__t0, align 8
...
for.body:                                         ; preds = %for.cond
  %arraydecay24 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %z, i64 0, i64 0
  %arraydecay25 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %x, i64 0, i64 0
  %arraydecay26 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %y, i64 0, i64 0
  call void @__gmpz_gcd(ptr noundef %arraydecay24, ptr noundef %arraydecay25, ptr noundef %arraydecay26)
  br label %for.inc
...
do.end34:                                         ; preds = %do.end
  ...
  %div36 = fdiv double 1.000000e+04, %20
  %conv37 = fptoui double %div36 to i64
  %add = add i64 1, %conv37
  store i64 %add, ptr %niter, align 8
  %21 = load i64, ptr %m, align 8
  %22 = load i64, ptr %n, align 8
  %23 = load i64, ptr %niter, align 8
  %call38 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %21, i64 noundef %22, i64 noundef %23)
  %24 = load ptr, ptr @stdout, align 8
  %call39 = call i32 @fflush(ptr noundef %24)
  %call40 = call i32 @cputime()
  %conv41 = sext i32 %call40 to i64
  store i64 %conv41, ptr %t0, align 8
  %25 = load i64, ptr %niter, align 8
  store i64 %25, ptr %i, align 8
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc49, %do.end34
  %26 = load i64, ptr %i, align 8
  %cmp43 = icmp ugt i64 %26, 0
  br i1 %cmp43, label %for.body45, label %for.end50

for.body45:                                       ; preds = %for.cond42
  %arraydecay46 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %z, i64 0, i64 0
  %arraydecay47 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %x, i64 0, i64 0
  %arraydecay48 = getelementptr inbounds [1 x %struct.__mpz_struct], ptr %y, i64 0, i64 0
  call void @__gmpz_gcd(ptr noundef %arraydecay46, ptr noundef %arraydecay47, ptr noundef %arraydecay48)
  br label %for.inc49
...
for.end50:                                        ; preds = %for.cond42
  %call51 = call i32 @cputime()
  %conv52 = sext i32 %call51 to i64
  %28 = load i64, ptr %t0, align 8
  %sub53 = sub i64 %conv52, %28
  store i64 %sub53, ptr %ti, align 8
  %call54 = call i32 (ptr, ...) @printf(ptr noundef @.str.5)
  %29 = load i64, ptr %niter, align 8
  %conv55 = uitofp i64 %29 to double
  %mul = fmul double 1.000000e+03, %conv55
  %30 = load i64, ptr %ti, align 8
  %conv56 = uitofp i64 %30 to double
  %div57 = fdiv double %mul, %conv56
  store double %div57, ptr %ops_per_sec, align 8
  store double 1.000000e+02, ptr %f, align 8
  store i32 0, ptr %decimals, align 4
  br label %for.cond58

for.cond58:                                       ; preds = %for.inc64, %for.end50
  %31 = load double, ptr %ops_per_sec, align 8
  %32 = load double, ptr %f, align 8
  %cmp59 = fcmp ogt double %31, %32
  br i1 %cmp59, label %if.then61, label %if.end62

if.then61:                                        ; preds = %for.cond58
  br label %for.end66

if.end62:                                         ; preds = %for.cond58
  %33 = load double, ptr %f, align 8
  %mul63 = fmul double %33, 1.000000e-01
  store double %mul63, ptr %f, align 8
  br label %for.inc64

for.inc64:                                        ; preds = %if.end62
  %34 = load i32, ptr %decimals, align 4
  %inc65 = add nsw i32 %34, 1
  store i32 %inc65, ptr %decimals, align 4
  br label %for.cond58

for.end66:                                        ; preds = %if.then61
  %35 = load i32, ptr %decimals, align 4
  %36 = load double, ptr %ops_per_sec, align 8
  %call67 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %35, double noundef %36)
  store i32 0, ptr %retval, align 4
  br label %return
